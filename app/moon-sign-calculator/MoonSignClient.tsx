  ...
  return (
    <>
      ...
      <section style={{ padding:"80px 0", background:"#0d0d18", borderTop:"1px solid var(--border)" }}>
        <div className="ms-c" style={{ maxWidth:760 }}>
      ...
      <footer style={{ borderTop:"1px solid var(--border)", padding:"36px 0" }}>
        <div className="ms-c" style={{ display:"flex", alignItems:"center", justifyContent:"space-between", flexWrap:"wrap", gap:16 }}>
          <div>
            <Link href="/" className="ms-logo" style={{ marginBottom:6 }}><span className="g">BluntChart</span></Link>
          ...
          <div style={{ display:"flex", gap:20, fontSize:13 }}>
            ...
            <Link href="/big-three-calculator" style={{ color:"rgba(232,228,240,0.35)", textDecoration:"none" }}>Big Three</Link>
