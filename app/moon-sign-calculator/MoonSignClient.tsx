        ...
        <div className="ms-c" style={{ position:"relative", zIndex:1 }}>
          ...
          <div style={{ maxWidth:720, margin:"0 auto", textAlign:"center" }}>
            ...
            <h1 style={{ fontFamily:"var(--font-display)", fontSize:"clamp(2.2rem,5.5vw,3.6rem)", fontWeight:900, lineHeight:1.08, letterSpacing:"-0.02em", marginBottom:14 }}>
              What your Moon sign<br/><em style={{ fontStyle:"italic", background:"linear-gradient(135deg,#c4a8ff,#d4537e)", WebkitBackgroundClip:"text", WebkitTextFillColor:"transparent", backgroundClip:"text" }}>actually says about you.</em>
            </h1>
