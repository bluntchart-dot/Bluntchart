      ...
      <main>
        <div className="c">
          ...
          <div className="sign-grid">
            {SIGNS.map((s) => (
              <Link className="sign-card" href={`/saturn-return-in-${s.sign.toLowerCase()}`} key={s.sign} style={{ display: "block", textDecoration: "none" }}>
                ...
                <div style={{ fontSize: ".78rem", color: "var(--gold)", marginTop: 10, fontWeight: 600 }}>Read full guide →</div>
              </Link>
            ))}
          </div>
