...
export const IN_DEPTH_READING_GUIDELINES: GuidelineMap = {
  ...
  "whats-happening-now": {
    ...
    narrativeForm: "guess",
    emotionalObjective:
      "This is the BIG chapter — the hook, the substance, and the emotional core of Part I. Three full pages. The reader should finish thinking 'how does this know what's happening in my life?' Go DEEP into 4–5 life areas that the transits are activating right now. Pick the 4–5 strongest from: (1) Career & professional direction — job changes, promotions, stagnation, business decisions. (2) Love, marriage & relationships — meeting someone, rough patches, commitment questions. (3) Finances, wealth & abundance — financial strain, investment windows, new income streams. (4) Health, energy & well-being — exhaustion, burnout, mental health, recovery timelines. (5) Life purpose & identity shifts — outgrowing old goals, becoming someone new, stepping into authentic power. (6) Home, family & relocation — moves, family tension, property decisions. (7) Timing of major life milestones — Saturn Returns, difficult periods, lucky breaks. Lead with whichever area the transits hit hardest. Skip any area the chart barely touches. Each area gets REAL depth — multiple paragraphs, daily-life specifics, emotional resonance. This is NOT a survey. It's a deep, dramatic, ground-level conversation about their actual life right now.",
    tone: "Your most dramatic, best-friend energy. Talk like someone who grabbed them by the shoulders at 2am and said 'okay, we need to talk about what's happening.' Layman language. No astrology jargon in the flow. Ground-level. The kind of friend who makes you feel seen and a little called out at the same time.",
    desiredReaderFeeling:
      "\"How did it know that? That is literally my life right now. Every single part of it.\"",
    writingStyle:
      "Open with a small, specific guess about their recent weeks — something uncannily accurate. Then go DEEP across 4–5 life areas. Each area gets its own stretch of paragraphs — not a sentence, not a paragraph, but a real conversation about what's happening there. Talk about career like you've watched them refresh their inbox and wonder if this is it. Talk about love like you've seen the texts they almost sent. Talk about money like you know which tab they close fastest. Talk about health like you noticed the exhaustion they keep brushing off. Talk about identity like you've watched them stare at the ceiling wondering who they're becoming. Be dramatic. Be specific. Use layman language — the way a best friend talks, not a therapist or an astrologer. Connect every observation to what it actually looks like in their daily life. NEVER repeat the same topic once you've moved on. NEVER be surface-level — if you can't go deep on an area, skip it entirely and give more space to the ones you can. End on what this entire period is actually asking of them — the big picture of why their life feels this way right now.",
    approxWords: [1500, 1900],
    transitionGoal:
